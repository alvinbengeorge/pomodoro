      ...
      <div className='text-center'>
        ...
        <div className='grid gap-2'>
          ...
          <div className="buttons grid gap-2 grid-cols-2">
            <button onClick={toggle} className={`btn ${isCooldown ? 'btn-error' : 'btn-success'}`}>{isActive ? 'Pause' : 'Start'}</button>
            <button onClick={reset} className={`btn ${isCooldown ? 'btn-error' : 'btn-success'}`}>Reset</button>
          </div>
        </div>
      </div>
    </div>
